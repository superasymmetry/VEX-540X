...
void autonomous() {  // in-game autonomous
	toggle_intake();
	pros::delay(500);
	chassis.setPose(-58, 1, 90);
	chassis.moveToPoint(-47, 1, 10000);
	chassis.turnToHeading(180, 1000);
	toggle_intake();
	grab_stake();
	chassis.moveToPoint(-47, 18.2, 10000, {.forwards = false});
	pros::delay(650);
	grab_stake();
	chassis.turnToHeading(80, 1000);
	toggle_intake();
	chassis.moveToPoint(-23.5, 23.5, 10000);
	pros::delay(500);
	chassis.turnToHeading(0, 1000);
	chassis.moveToPoint(-23.5, 47, 10000);
	pros::delay(500);
