...
void autonomous() {  // in-game autonomous
	...
	/*
	pros::lcd::set_text(6, "blue plus secure mogo");
	chassis.setPose(-64.9, -47.3, 240);
	pros::delay(450);

	grab_stake();
	chassis.moveToPose(-23.5, -23.5, 240, 10000, {.forwards = false});
	grab_stake();
	pros::delay(250);
	chassis.turnToHeading(60, 10000);
	pros::delay(250);
	chassis.moveToPoint(-65, -42.5, 10000);
	grab_stake();
	*/
}
